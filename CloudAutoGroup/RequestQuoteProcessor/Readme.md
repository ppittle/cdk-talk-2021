...
Execute unit tests
```
    cd "CloudAutoGroup.TVCampaign.RequestQuoteProcessor/test/CloudAutoGroup.TVCampaign.RequestQuoteProcessor.Tests"
    dotnet test
```

Deploy function to AWS Lambda
```
    cd "CloudAutoGroup.TVCampaign.RequestQuoteProcessor/src/CloudAutoGroup.TVCampaign.RequestQuoteProcessor"
